 ...
 * @param value The node's value. This should only be present on terminal
 * nodes/leaves, and empty otherwise.
 */
 ...
 */
list<ParseTree*> ParseTree::getChildren() { return ParseTree::children; }

/**
 * Get the type of this Node
 * @return The type of node (see element types).
 */
string ParseTree::getType() { return ParseTree::type; }

/**
 * Get the value of this Node
 * @return The node's value. This should only be used on terminal nodes/leaves,
 * and empty otherwise.
 */
string ParseTree::getValue() { return ParseTree::value; }

/**
 * Generate a string from this ParseTree
 * @return A printable representation of this ParseTree
 */
string ParseTree::tostring() { return ParseTree::tostring(0); }
